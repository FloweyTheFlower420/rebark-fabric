...
public class Tags {
    private static final TagKey<Block> REBARK_BLACKLIST_TAG =
        TagKey.create(Registry.BLOCK_REGISTRY, new ResourceLocation(RebarkMain.MODID, "rebark_blacklist"));
    private static final TagKey<Block> STRIP_BLACKLIST_TAG =
        TagKey.create(Registry.BLOCK_REGISTRY, new ResourceLocation(RebarkMain.MODID, "strip_blacklist"));
    private static final TagKey<Block> REBARK_WHITELIST_TAG =
        TagKey.create(Registry.BLOCK_REGISTRY, new ResourceLocation(RebarkMain.MODID, "rebark_blacklist"));
    private static final TagKey<Block> STRIP_WHITELIST_TAG =
        TagKey.create(Registry.BLOCK_REGISTRY, new ResourceLocation(RebarkMain.MODID, "strip_blacklist"));
